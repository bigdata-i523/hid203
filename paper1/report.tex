...
The growth of data has been following an exponenetial rate with huge amount of data being generated every second. In today's world, having Terabyte or even Petabytes of data to deal with is not uncommon. The challenge is not only the volume of data but also the variety of data to deal with. This has led to the birth of one of the most talked about term in today's technological world, i.e., Big Data. Most of the organizations today are collecting big data with the goal of extracting \emph{value} from exploratory analysis of this data and use this information to make business decisions. However, analyzing such enormous data is in itself a huge challenge and this is where big data analytics frameworks like Spark come to rescue. Spark is a general distributed computing framework that is optimized for in-memory processing. We show how Spark supports faster data analysis and is proving to be one of the most successful framework for Big Data Analytics.
